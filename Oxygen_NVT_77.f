     ...
     :mass,tbl_SQ,dt) result(mass_term)
      ...
      OPEN(92,FILE="Energies_O2_77.txt")
      OPEN(91,FILE="O2_positions_77.gro") ! open output traj file
      OPEN(94,FILE="Temp_77.txt") ! open output temperature
      OPEN(95,FILE="Velocity_O2_77.txt")
      OPEN(96,FILE="Velocity_vector_O2_77.txt")
      OPEN(97,FILE="G_r_all_distances_O2_77.txt")
      OPEN(98,FILE="Oxygen_NVT_77.gro")
      ...
      ! Read in intial file
      !----------------------
      OPEN(11,FILE="Oxygen_cool.gro") ! open input file
      READ(11,*)
      READ(11,*)
      DO I=1,nMol
